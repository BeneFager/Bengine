...
namespace Bengine
{
	...
	void ImGuiLayer::OnUpdate()
	{
		...
		io.DeltaTime = m_Time > 0.0 ? (time - m_Time) : 1;
		m_Time = time;
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(BE_BIND_EVENT_FN(ImGuiLayer::OnWindowRezisedEvent));
	}
	...
	bool ImGuiLayer::OnWindowRezisedEvent(WindowResizeEvent& e)
	{
		ImGuiIO& io = ImGui::GetIO();
